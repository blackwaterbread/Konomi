...
<img width="1989" height="1090" alt="Image" src="https://github.com/user-attachments/assets/dd556da2-09c6-4942-9fb3-b16ae024fa9f" />
...
* Compatibility with NovelAI and WebUI, Midjourney, ComfyUI PNG, WebP metadata
...
* Hybrid similar-image analysis based on perceptual hash and Jaccard similarity
* Prompt editing that treats prompts like reusable building blocks
* Reusable prompt group system
* Advanced and conditional prompt features
* Image generation through the NovelAI API
* Automatic image generation
* ComfyUI workflow visualization with interactive node graph viewer
