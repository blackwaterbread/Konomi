...
// WebP steganography requires native addon (webp-alpha).
// Not available in core — consumers can provide their own decoder.
export function readNaiMetaFromWebp(_buf: Buffer): ImageMeta | null {
  return null;
}
